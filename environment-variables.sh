...
export STARTUP_SCRIPT_BUCKET_CUSTOM_ROLE="cicdbucketCustomRole.$VERSION"
...
export ADMIN_PASSWORD=$DB_PASSWORD
...
export APP_CUSTOM_ROLE="cicdappCustomRole.$VERSION"
export APP_PORT=9000
...
export SA=$(gcloud config get project)
